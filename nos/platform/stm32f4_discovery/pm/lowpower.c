...
extern UINT32 mysystem_save(unsigned long);
extern UINT32 mysystem_save_standby(unsigned long);
...
//	stime = MT_get_time();
	...
	if (mysystem_save_standby(delta * 10)) {
...
here1:
	...
	printf("lp_enter_standby_mode: restore & exit\r\n");
